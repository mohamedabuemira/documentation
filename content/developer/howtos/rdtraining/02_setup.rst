...
- `Here is an explanation of how to set up a Python linter in VSCode`_. There are multiple
  linter options you are free to choose from, but `Flake8`_ is a popular choice.
...
.. _Here is an explanation of how to set up a Python linter in VSCode: https://code.visualstudio.com/docs/python/linting
